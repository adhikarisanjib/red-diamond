"""
Django settings for red_diamond project.
...
SECRET_KEY = "django-insecure-=x$lt0@fm1=wb!6-79httt7s2*p*5iky)uakn^6%w&$_h17l=)"
...
WSGI_APPLICATION = "red_diamond.wsgi.application"
